...
{% endhighlight %}
In the following section we will address another important use case, the digital signature of a document, in which a hash function is used to compute the fingerprint of a file.
## Digital signature
